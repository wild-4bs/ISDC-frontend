...
function AlertDialogHeader({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col gap-2.5 text-center items-center",
        className,
      )}
      {...props}
    />
...
function AlertDialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-4 sm:flex-row justify-center",
        className,
      )}
      {...props}
    />
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      className={cn(buttonVariants({ variant }), "text-foreground", className)}
      {...props}
    />
  );
}
